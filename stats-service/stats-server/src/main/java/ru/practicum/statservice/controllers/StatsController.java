...
public class StatsController {
    ...
    @GetMapping
    public ResponseEntity<ArrayList<ViewStats>> getStats(@RequestParam @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
                                                         LocalDateTime start,
        ...
        return ResponseEntity.status(HttpStatus.OK).body(statsService.getStats(start, end, unique, uris));
    }
}
